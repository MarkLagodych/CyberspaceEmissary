...
export class GameRunner {
    ...
    static __wrap(ptr) {
        const obj = Object.create(GameRunner.prototype);
        obj.ptr = ptr;
    ...
    free() {
        ...
        wasm.__wbg_gamerunner_free(ptr);
    }
    /**
    */
    constructor() {
        const ret = wasm.gamerunner_new();
        return GameRunner.__wrap(ret);
    }
    /**
    * @returns {boolean}
    */
    has_stopped() {
        const ret = wasm.gamerunner_has_stopped(this.ptr);
        return ret !== 0;
    }
    /**
    */
